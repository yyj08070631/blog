...
DH 握手与 RSA 握手最大的区别在于：RSA 握手在密钥交换 + 身份认证的过程中使用了 RSA 生成的同一组密钥，这种做法效率比较高，但是存在[前向安全性（Perfect forward secrecy）](https://zh.wikipedia.org/wiki/%E5%89%8D%E5%90%91%E4%BF%9D%E5%AF%86)的问题。在 DH 握手中
