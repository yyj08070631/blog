...
![Record Protocol 示意](https://i.ytimg.com/vi/bSMRf0lAuzw/maxresdefault.jpg)
...
由于篇幅较长，直接放在[另一篇文章](/network/008.md)中~
...
最后推荐 byronhe 大佬这篇 [TLS协议分析 与 现代加密通信协议设计](https://blog.helong.info/post/2015/09/06/tls-protocol-analysis-and-crypto-protocol-design/)，文章从密码学的角度探究了 TLS 协议加密过程的设计，分析非常全面，还附有大量的参考资料链接，有需要拓展知识深度的同学可以继续阅读这一篇。
